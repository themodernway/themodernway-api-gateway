...
@RequestBinding('/demo/posts')
class GetPosts extends RESTServiceSupport
{
    @Override
    def call(final IRESTRequestContext context, final JSONObject object) throws Exception
    {
        network().get('https://jsonplaceholder.typicode.com/posts/{id}', new PathParameters(id: 50)).json()
    }
}
